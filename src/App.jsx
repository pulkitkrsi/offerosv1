...
const css = `@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Instrument+Serif:ital@0;1&family=JetBrains+Mono:wght@400;500&display=swap');
:root,.light{--bg:#faf7f2;--bg2:#f3efe8;--bg3:#ebe7e0;--bg4:#ddd9d2;--border:rgba(50,40,30,.08);--border2:rgba(50,40,30,.14);--text:#1a1714;--text2:#4a4540;--text3:#8a847a;--accent:#eb212e;--accent2:#c91a25;--accent-bg:rgba(235,33,46,.05);--accent-soft:rgba(235,33,46,.08);--lime:#5cb85c;--lime-bg:rgba(92,184,92,.08);--green:#2d8a4e;--green-bg:rgba(45,138,78,.07);--red:#c0392b;--red-bg:rgba(192,57,43,.06);--amber:#d4930d;--amber-bg:rgba(212,147,13,.07);--blue:#2980b9;--blue-bg:rgba(41,128,185,.07);--purple:#7d3fa0;--purple-bg:rgba(125,63,160,.06);--teal:#1a9a7a;--teal-bg:rgba(26,154,122,.06);--sage:#5a8a6a;--sage-bg:rgba(90,138,106,.07);--r:8px;--r2:12px;--r3:16px;--sh-sm:0 1px 3px rgba(40,30,15,.06);--sh:0 1px 3px rgba(40,30,15,.05),0 8px 24px -8px rgba(40,30,15,.12);--sh-lg:0 2px 4px rgba(40,30,15,.06),0 20px 44px -12px rgba(40,30,15,.18);--font-display:'Instrument Serif',Georgia,serif;--font-ui:'Inter',-apple-system,sans-serif;--font-mono:'JetBrains Mono',monospace}
.dark{--bg:#12110f;--bg2:#1a1916;--bg3:#24221f;--bg4:#302e2a;--border:rgba(255,248,230,.07);--border2:rgba(255,248,230,.12);--text:#f0ece4;--text2:#a8a49c;--text3:#706c64;--accent:#eb212e;--accent2:#ff3a48;--accent-bg:rgba(235,33,46,.1);--accent-soft:rgba(235,33,46,.14);--lime:#6dce6d;--lime-bg:rgba(109,206,109,.1);--green:#4eca6a;--green-bg:rgba(78,202,106,.1);--red:#e85a4f;--red-bg:rgba(232,90,79,.1);--amber:#e8b830;--amber-bg:rgba(232,184,48,.1);--blue:#5dade2;--blue-bg:rgba(93,173,226,.1);--purple:#a87ccf;--purple-bg:rgba(168,124,207,.08);--teal:#3cc8a8;--teal-bg:rgba(60,200,168,.08);--sage:#70b880;--sage-bg:rgba(112,184,128,.1);--sh-sm:0 1px 2px rgba(0,0,0,.25);--sh:0 2px 8px rgba(0,0,0,.35);--sh-lg:0 8px 30px rgba(0,0,0,.45)}
...
.sb-brand{display:flex;align-items:center;gap:10px;padding:6px 8px 20px;font-size:16px;font-weight:600;letter-spacing:-0.02em;cursor:pointer}.sb-brand-mark{width:28px;height:28px;border-radius:8px;background:var(--accent);display:grid;place-items:center;color:#fff;font-weight:700;font-size:11px;flex-shrink:0;box-shadow:0 2px 8px rgba(235,33,46,.25)}
.sb-org{display:flex;align-items:center;gap:8px;padding:9px 10px;border:1px solid var(--border);border-radius:var(--r);margin-bottom:14px;cursor:pointer;transition:all .12s}.sb-org:hover{background:var(--bg3)}.sb-org-avatar{width:26px;height:26px;border-radius:7px;background:linear-gradient(135deg,var(--accent),#e67e22);color:#fff;display:grid;place-items:center;font-size:10px;font-weight:700;flex-shrink:0}.sb-org .name{flex:1;font-size:13px;font-weight:500}.sb-org .caret{color:var(--text3);font-size:12px}
...
.sb-item{display:flex;align-items:center;gap:10px;padding:9px 11px;border-radius:var(--r);color:var(--text3);font-size:13px;cursor:pointer;width:100%;text-align:left;transition:all .1s;font-weight:500;border:1px solid transparent}.sb-item:hover{background:var(--bg3);color:var(--text)}.sb-item.active{background:var(--bg);color:var(--text);border-color:var(--border);box-shadow:var(--sh-sm)}.sb-item .icon{width:16px;height:16px;display:flex;align-items:center;flex-shrink:0}.sb-item .badge{margin-left:auto;font-size:10px;background:var(--accent-bg);color:var(--accent);padding:2px 7px;border-radius:10px;font-weight:600}
.sb-foot{margin-top:auto;padding:14px 8px;border-top:1px solid var(--border);display:flex;align-items:center;gap:10px}.sb-foot-avatar{width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,var(--accent),#e67e22);color:#fff;display:grid;place-items:center;font-size:12px;font-weight:600;flex-shrink:0}.sb-foot .who{font-size:13px;font-weight:500}.sb-foot .role{font-size:11px;color:var(--text3)}
/* Topbar */
.topbar{display:flex;align-items:center;gap:14px;padding:14px 28px;border-bottom:1px solid var(--border);background:var(--bg);position:sticky;top:0;z-index:10}
...
.page-hdr{padding:28px 0 22px}.page-hdr h1{font-family:var(--font-display);font-size:36px;font-weight:400;letter-spacing:-0.015em;line-height:1.1}.page-hdr-sub{font-size:13px;color:var(--text3);cursor:pointer;display:flex;align-items:center;gap:4px;margin-bottom:6px}.page-hdr-sub:hover{color:var(--text)}
/* Cards */
.card{background:var(--bg);border:1px solid var(--border);border-radius:var(--r3);padding:22px;margin-bottom:16px;box-shadow:var(--sh-sm)}.card-title{font-family:var(--font-display);font-size:24px;margin-bottom:16px;font-weight:400;letter-spacing:-0.01em}
/* Segments */
.seg-cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:10px;margin-bottom:14px}.seg-card{border:1px solid var(--border);border-radius:var(--r2);padding:16px;cursor:pointer;transition:all .12s;background:var(--bg)}.seg-card:hover{border-color:var(--border2);box-shadow:var(--sh-sm)}.seg-card.selected{border-color:var(--accent);background:var(--accent-bg);box-shadow:0 0 0 3px var(--accent-soft)}.seg-card-icon{font-size:22px;margin-bottom:8px}.seg-card-name{font-weight:600;font-size:14px;margin-bottom:3px}.seg-card-desc{font-size:12px;color:var(--text3);margin-bottom:8px}.seg-card-insight{font-size:11px;color:var(--text2);line-height:1.5;padding-top:8px;border-top:1px solid var(--border);font-style:italic}
.csv-zone{margin-top:14px;padding:18px;border:1px dashed var(--border2);border-radius:var(--r2);background:var(--bg2);transition:all .12s;cursor:pointer;text-align:center}.csv-zone:hover{border-color:var(--teal);background:var(--teal-bg)}.csv-zone.has{border-color:var(--teal);border-style:solid;background:var(--teal-bg)}.csv-logic{margin-top:10px;display:flex;gap:8px;align-items:center;font-size:12px;color:var(--text3)}
...
input[type=text],input[type=number],input[type=date],input[type=password],select,textarea{background:var(--bg);border:1px solid var(--border);border-radius:var(--r);padding:9px 12px;color:var(--text);font-size:13px;width:100%;transition:border-color .12s}input:focus,select:focus,textarea:focus{outline:none;border-color:var(--accent);box-shadow:0 0 0 3px var(--accent-soft)}input::placeholder{color:var(--text3)}select{cursor:pointer}
.preload-box{margin-top:16px;padding:18px;background:var(--bg2);border:1px solid var(--border);border-radius:var(--r2)}.toggle-row{display:flex;align-items:center;justify-content:space-between}.toggle-label{font-size:13px;font-weight:600}.toggle-sub{font-size:11px;color:var(--text3)}.toggle-track{width:42px;height:24px;border-radius:12px;background:var(--bg4);cursor:pointer;position:relative;transition:.2s;flex-shrink:0}.toggle-track.on{background:var(--lime)}.toggle-thumb{position:absolute;width:18px;height:18px;border-radius:50%;top:3px;left:3px;background:#fff;transition:.2s;box-shadow:0 1px 3px rgba(0,0,0,.12)}.toggle-track.on .toggle-thumb{transform:translateX(18px)}
.dist-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:14px 0}.dist-item{border:1px solid var(--border);border-radius:var(--r2);padding:14px;cursor:pointer;transition:all .12s;background:var(--bg)}.dist-item:hover{border-color:var(--border2)}.dist-item.selected{border-color:var(--lime);background:var(--lime-bg)}.dist-item-title{font-size:12px;font-weight:600;margin-bottom:3px}.dist-item-desc{font-size:11px;color:var(--text3)}
.act-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px}.act-item{border:1px solid var(--border);border-radius:var(--r3);padding:18px;cursor:pointer;transition:all .12s;background:var(--bg)}.act-item:hover{box-shadow:var(--sh-sm)}.act-item.selected{border-color:var(--accent);background:var(--accent-bg);box-shadow:0 0 0 3px var(--accent-soft)}.act-item-icon{font-size:24px;margin-bottom:8px}.act-item-title{font-size:14px;font-weight:600;margin-bottom:3px}.act-item-vars{font-size:12px;color:var(--text3)}
.rwd-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:18px}.rwd-item{border:1px solid var(--border);border-radius:var(--r2);padding:16px;cursor:pointer;transition:all .12s;background:var(--bg)}.rwd-item:hover{box-shadow:var(--sh-sm)}.rwd-item.selected{border-color:var(--accent);background:var(--accent-bg)}.rwd-item.disabled{opacity:.25;pointer-events:none}.rwd-item-name{font-size:14px;font-weight:600;margin-bottom:3px}.rwd-item-formula{font-size:12px;color:var(--text3)}
.rwd-disabled{padding:14px 16px;background:var(--lime-bg);border:1px solid rgba(92,184,92,.15);border-radius:var(--r);font-size:13px;color:var(--green);margin-bottom:18px;line-height:1.6}
.rwd-config{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r2);padding:18px 22px;margin-top:8px}.rwd-config-title{font-size:10px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:var(--text3);margin-bottom:16px}
...
.wt-box{margin-top:18px;padding:18px 20px;border:1px solid rgba(235,33,46,.1);border-radius:var(--r2);background:var(--accent-bg)}.wt-title{font-size:10px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:var(--accent);margin-bottom:14px}
.wt-modes{display:flex;gap:8px;margin-bottom:14px}.wt-mode{padding:7px 16px;border-radius:22px;border:1px solid var(--border);background:var(--bg);color:var(--text3);font-size:12px;cursor:pointer;font-weight:500;transition:all .12s}.wt-mode:hover{border-color:var(--text3)}.wt-mode.active{border-color:var(--accent);color:var(--accent);background:var(--accent-bg)}
...
.bc-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.bc-note{font-size:12px;color:var(--text2);margin-top:14px;padding:12px 16px;background:var(--bg2);border-left:3px solid var(--accent);border-radius:0 var(--r) var(--r) 0;line-height:1.6}
.sum-card{border:1px solid var(--border);border-radius:var(--r3);overflow:hidden;margin-bottom:18px;box-shadow:var(--sh-sm)}.sum-hdr{padding:18px 24px;background:var(--bg2);border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center}.sum-name{font-family:var(--font-display);font-size:22px}
.badge{font-size:10px;padding:4px 12px;border-radius:22px;font-weight:600}.bg-cashback{background:var(--green-bg);color:var(--green)}.bg-discount{background:var(--amber-bg);color:var(--amber)}.bg-xp{background:var(--purple-bg);color:var(--purple)}.bg-coupon{background:var(--blue-bg);color:var(--blue)}.bg-preload{background:var(--teal-bg);color:var(--teal)}
.sum-body{padding:24px}.sum-plain{font-size:14px;line-height:1.9;color:var(--text2);margin-bottom:24px;padding:18px 20px;background:var(--bg2);border-radius:var(--r);border-left:3px solid var(--accent)}.sum-plain strong{color:var(--accent);font-weight:600}
.vtable{width:100%;border-collapse:collapse}.vtable th{font-size:10px;font-weight:600;letter-spacing:.04em;text-transform:uppercase;color:var(--text3);text-align:left;padding:8px 12px;border-bottom:1px solid var(--border)}.vtable td{padding:8px 12px;border-bottom:1px solid var(--border);font-size:13px}.vtable tr:last-child td{border-bottom:none}.vtable tr:hover td{background:var(--bg2)}
...
.sample-btn{width:100%;padding:12px;margin-bottom:16px;border:1px dashed var(--accent);border-radius:var(--r);background:var(--accent-bg);color:var(--accent);font-size:13px;font-weight:500;cursor:pointer;transition:all .12s}.sample-btn:hover{background:var(--accent-soft)}
.dash-section{margin-bottom:28px}.dash-title{font-family:var(--font-display);font-size:24px;margin-bottom:16px;display:flex;align-items:center;gap:12px;font-weight:400}.dash-icon{width:32px;height:32px;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0}.di-g{background:var(--green-bg);color:var(--green)}.di-a{background:var(--amber-bg);color:var(--amber)}.di-r{background:var(--accent-bg);color:var(--accent)}
.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:12px}.mc{background:var(--bg);border:1px solid var(--border);border-radius:var(--r3);padding:18px;box-shadow:var(--sh-sm)}.mc-label{font-size:10px;font-weight:600;color:var(--text3);letter-spacing:.04em;text-transform:uppercase;margin-bottom:8px}.mc-val{font-family:var(--font-display);font-size:30px;letter-spacing:-0.01em}.mc-sub{font-size:11px;color:var(--text3);margin-top:5px}
.result-tbl{width:100%;border-collapse:collapse;font-size:12px}.result-tbl th{font-size:10px;font-weight:600;letter-spacing:.04em;text-transform:uppercase;color:var(--text3);text-align:left;padding:10px;border-bottom:1px solid var(--border)}.result-tbl td{padding:10px;border-bottom:1px solid var(--border);color:var(--text2)}.result-tbl tr:last-child td{border-bottom:none}.result-tbl tr:hover td{background:var(--bg2)}.result-tbl td.rval{color:var(--accent);font-family:var(--font-mono);font-weight:600}
.sbadge{font-size:10px;padding:3px 10px;border-radius:22px;font-weight:500;display:inline-block}.bg-green{background:var(--green-bg);color:var(--green)}.bg-amber{background:var(--amber-bg);color:var(--amber)}.bg-red{background:var(--red-bg);color:var(--red)}.bg-blue{background:var(--blue-bg);color:var(--blue)}.bg-muted{background:var(--bg3);color:var(--text3)}
.risk-item{display:flex;align-items:flex-start;gap:10px;padding:14px 16px;border-radius:var(--r);margin-bottom:8px;font-size:13px;line-height:1.6}.risk-item.risk{background:var(--red-bg);color:var(--red)}.risk-item.warn{background:var(--amber-bg);color:var(--amber)}.risk-item.ok{background:var(--green-bg);color:var(--green)}
.btn-row{display:flex;gap:10px;margin-top:22px}.btn{padding:10px 18px;border-radius:var(--r);border:1px solid var(--border);background:var(--bg);color:var(--text);font-size:13px;font-weight:500;cursor:pointer;transition:all .1s;display:inline-flex;align-items:center;gap:8px}.btn:hover{background:var(--bg2);box-shadow:var(--sh-sm)}.btn-primary{background:var(--accent);border-color:var(--accent);color:#fff;box-shadow:0 2px 8px rgba(235,33,46,.2)}.btn-primary:hover{background:var(--accent2)}.btn-dashed{width:100%;padding:10px;border:1px dashed var(--border2);border-radius:var(--r);background:none;font-size:12px;color:var(--text3);cursor:pointer;font-weight:500;margin-top:8px;transition:all .12s}.btn-dashed:hover{border-color:var(--accent);color:var(--accent)}.del-btn{background:none;border:none;color:var(--text3);cursor:pointer;font-size:15px;transition:color .12s}.del-btn:hover{color:var(--red)}.scroll-x{overflow-x:auto}
.steps{display:flex;gap:0;margin-bottom:20px;background:var(--bg2);border:1px solid var(--border);border-radius:var(--r2);padding:4px;overflow-x:auto}.step{flex:1;padding:10px 8px;font-size:12px;cursor:pointer;color:var(--text3);text-align:center;border-radius:var(--r);transition:all .12s;white-space:nowrap;font-weight:500}.step:hover{color:var(--text2)}.step.active{background:var(--bg);color:var(--text);box-shadow:var(--sh-sm)}.step.done{color:var(--green)}.step.incomplete{color:var(--red)}
.offers-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:14px}.offer-card{background:var(--bg);border:1px solid var(--border);border-radius:var(--r3);padding:18px;cursor:pointer;transition:all .12s;position:relative}.offer-card:hover{box-shadow:var(--sh);border-color:var(--border2)}.offer-card.active{border-color:var(--accent)}.offer-card-actions{position:absolute;top:12px;right:12px;display:flex;gap:4px;opacity:0;transition:opacity .12s}.offer-card:hover .offer-card-actions{opacity:1}.offer-card-actions button{width:28px;height:28px;border-radius:6px;border:1px solid var(--border);background:var(--bg);font-size:14px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:var(--text3)}.offer-card-actions button:hover{background:var(--bg3);color:var(--text)}.offer-card-actions button.del:hover{color:var(--red)}
.offer-card-type{display:flex;align-items:center;gap:8px;margin-bottom:10px}.offer-card-dot{width:8px;height:8px;border-radius:50%}.offer-card-label{font-size:10px;color:var(--text3);font-weight:600;text-transform:uppercase;letter-spacing:.04em}.offer-card-name{font-family:var(--font-display);font-size:20px;margin-bottom:4px;letter-spacing:-0.01em}.offer-card-segs{font-size:12px;color:var(--text3)}
.add-card{border:1px dashed var(--border2);border-radius:var(--r3);padding:18px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:var(--text3);font-size:14px;font-weight:500;min-height:120px;transition:all .12s}.add-card:hover{border-color:var(--accent);color:var(--accent);background:var(--accent-bg)}
.campaign-list{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:14px;margin-bottom:22px}.campaign-card{background:var(--bg);border:1px solid var(--border);border-radius:var(--r3);padding:22px;cursor:pointer;transition:all .12s;position:relative}.campaign-card:hover{box-shadow:var(--sh);border-color:var(--border2)}.campaign-card-name{font-family:var(--font-display);font-size:22px;margin-bottom:8px}.campaign-card-meta{font-size:12px;color:var(--text3);display:flex;gap:14px}
.save-indicator{font-size:11px;color:var(--text3);display:flex;align-items:center;gap:4px;transition:opacity .3s}.save-indicator.saving{color:var(--accent)}.save-indicator.saved{color:var(--green)}
...
.user-badge{display:flex;align-items:center;gap:6px;padding:4px;cursor:pointer;border-radius:var(--r);transition:background .12s}.user-badge:hover{background:var(--bg3)}.user-badge-avatar{width:28px;height:28px;border-radius:50%;background:var(--accent);color:#fff;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:600}.user-badge-name{font-size:12px;font-weight:500;color:var(--text2)}
.modal-overlay{position:fixed;inset:0;background:rgba(26,23,20,.35);display:flex;align-items:center;justify-content:center;z-index:200;backdrop-filter:blur(6px)}.modal{background:var(--bg);border:1px solid var(--border);border-radius:var(--r3);padding:30px;max-width:460px;width:92%;box-shadow:var(--sh-lg)}.modal-title{font-family:var(--font-display);font-size:24px;margin-bottom:8px;font-weight:400}.modal-msg{font-size:13px;color:var(--text2);margin-bottom:22px;line-height:1.6}.modal-actions{display:flex;gap:10px;justify-content:flex-end}
/* Login — editorial */
.login-page{min-height:100vh;display:grid;grid-template-columns:1fr 1fr;background:var(--bg)}.login-hero{background:var(--bg2);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 40px;border-right:1px solid var(--border)}.login-hero-mark{width:64px;height:64px;border-radius:18px;background:var(--accent);display:grid;place-items:center;color:#fff;font-weight:700;font-size:22px;margin-bottom:24px;box-shadow:0 4px 20px rgba(235,33,46,.25)}.login-hero h2{font-family:var(--font-display);font-size:44px;text-align:center;line-height:1.1;margin-bottom:12px;font-weight:400;letter-spacing:-0.02em}.login-hero p{font-size:15px;color:var(--text2);text-align:center;max-width:360px;line-height:1.6}
.login-form{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 40px}.login-card{max-width:380px;width:100%}.login-logo{width:44px;height:44px;border-radius:12px;background:var(--accent);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:16px;margin:0 auto 20px;box-shadow:0 2px 10px rgba(235,33,46,.2)}.login-title{font-family:var(--font-display);font-size:28px;text-align:center;margin-bottom:4px;font-weight:400}.login-sub{font-size:13px;color:var(--text3);text-align:center;margin-bottom:30px}
...
.login-err{padding:12px 16px;background:var(--red-bg);border-radius:var(--r);font-size:13px;color:var(--red);margin-bottom:18px;text-align:center}
.login-btn{width:100%;padding:14px;background:var(--accent);border:none;border-radius:var(--r);color:#fff;font-size:14px;font-weight:600;cursor:pointer;transition:background .12s;margin-top:8px;box-shadow:0 2px 10px rgba(235,33,46,.2)}.login-btn:hover{background:var(--accent2)}.login-btn:disabled{opacity:.5;cursor:not-allowed}
/* AI drawer */
.ai-overlay{position:fixed;inset:0;background:rgba(26,23,20,.3);z-index:30;opacity:0;pointer-events:none;transition:opacity .2s;backdrop-filter:blur(4px)}.ai-overlay.open{opacity:1;pointer-events:auto}
.ai-drawer{position:fixed;top:0;right:-360px;width:360px;height:100vh;background:var(--bg);border-left:1px solid var(--border);z-index:31;display:flex;flex-direction:column;transition:right .25s ease;box-shadow:var(--sh-lg)}.ai-drawer.open{right:0}
.ai-hdr{padding:18px 20px;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between}.ai-hdr-t{font-family:var(--font-display);font-size:18px;display:flex;align-items:center;gap:10px;font-weight:400;color:var(--accent)}
.pulse{width:8px;height:8px;border-radius:50%;background:var(--accent);box-shadow:0 0 8px rgba(235,33,46,.4);animation:pulse 2s infinite}@keyframes pulse{0%,100%{opacity:1}50%{opacity:.4}}
.ai-x{background:none;border:none;color:var(--text3);cursor:pointer;font-size:18px;padding:4px 8px;border-radius:6px;transition:all .1s}.ai-x:hover{background:var(--bg3);color:var(--text)}
.ai-body{flex:1;overflow-y:auto;padding:18px}.ai-msg{margin-bottom:14px;padding:14px 16px;border-radius:var(--r2);font-size:13px;line-height:1.7;color:var(--text2)}.ai-msg.bot{background:var(--bg2);border:1px solid var(--border)}.ai-msg.user{background:var(--text);color:var(--bg);border-radius:var(--r2) var(--r2) 4px var(--r2)}.ai-msg strong{color:var(--accent);font-weight:600}.ai-msg code{font-family:var(--font-mono);font-size:11px;background:var(--bg3);padding:2px 5px;border-radius:4px}
...
.ai-ftr{padding:16px;border-top:1px solid var(--border)}.ai-ftr-row{display:flex;gap:8px}.ai-inp{flex:1;background:var(--bg2);border:1px solid var(--border);border-radius:var(--r);padding:10px 12px;color:var(--text);font-size:12px}.ai-inp:focus{outline:none;border-color:var(--accent)}.ai-go{background:var(--accent);border:none;border-radius:var(--r);color:#fff;font-size:12px;padding:8px 16px;cursor:pointer;font-weight:500;box-shadow:0 2px 6px rgba(235,33,46,.15)}.ai-go:hover{background:var(--accent2)}
.ai-qa{display:flex;gap:6px;margin-top:10px;flex-wrap:wrap}.ai-qa button{padding:5px 12px;font-size:11px;border:1px solid var(--border);border-radius:22px;background:var(--bg);color:var(--text3);cursor:pointer;font-weight:500;transition:all .1s}.ai-qa button:hover{border-color:var(--accent);color:var(--accent)}
/* What-If */
.wif-grid{display:grid;grid-template-columns:320px 1fr;gap:22px}.wif-knobs{display:flex;flex-direction:column;gap:14px}.wif-knob{background:var(--bg);border:1px solid var(--border);border-radius:var(--r2);padding:16px 18px}.wif-knob-head{display:flex;align-items:baseline;justify-content:space-between;margin-bottom:10px}.wif-knob-label{font-size:10px;letter-spacing:.04em;text-transform:uppercase;color:var(--text3);font-weight:600}.wif-knob-val{font-family:var(--font-display);font-size:26px;letter-spacing:-0.01em}.wif-knob-val .unit{font-size:13px;color:var(--text3);margin-left:2px}.wif-track{height:6px;background:var(--bg3);border-radius:3px;position:relative;cursor:pointer;margin:10px 0}.wif-track-fill{position:absolute;top:0;left:0;bottom:0;background:var(--accent);border-radius:3px}.wif-track-thumb{position:absolute;top:50%;width:18px;height:18px;border-radius:50%;background:var(--bg);border:2px solid var(--accent);transform:translate(-50%,-50%);box-shadow:var(--sh)}.wif-knob-meta{display:flex;justify-content:space-between;font-size:10px;color:var(--text3)}.wif-result{display:flex;flex-direction:column;gap:14px}.wif-headline{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:24px;display:grid;grid-template-columns:1fr 1fr 1fr;gap:22px}.wif-headline-block{padding-right:20px;border-right:1px solid var(--border)}.wif-headline-block:last-child{border-right:none;padding-right:0}.wif-headline-label{font-size:10px;letter-spacing:.06em;text-transform:uppercase;color:var(--text3);font-weight:600;margin-bottom:8px}.wif-headline-val{font-family:var(--font-display);font-size:32px;letter-spacing:-0.015em;line-height:1}.wif-headline-delta{display:flex;align-items:center;gap:6px;margin-top:8px;font-size:11px;color:var(--text3)}.wif-chip{font-family:var(--font-mono);font-size:10px;padding:2px 8px;border-radius:12px;font-weight:600}.wif-chip.up{background:var(--green-bg);color:var(--green)}.wif-chip.down{background:var(--red-bg);color:var(--red)}.wif-narrative{background:var(--accent-bg);border:1px solid rgba(235,33,46,.1);border-radius:var(--r2);padding:16px 18px;font-size:13px;color:var(--text2);line-height:1.7}.wif-narrative b{font-weight:600;color:var(--accent)}
/* Decision Board */
.db-summary{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:22px 24px;margin-bottom:20px;display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:22px;align-items:center}.db-status{border-right:1px solid var(--border);padding-right:22px}.db-status-orb{width:40px;height:40px;border-radius:50%;display:grid;place-items:center;font-size:20px;margin-bottom:8px}.db-status-orb.healthy{background:var(--green-bg);color:var(--green)}.db-status-orb.caution{background:var(--amber-bg);color:var(--amber)}.db-status-orb.risk{background:var(--red-bg);color:var(--red)}.db-status-text{font-family:var(--font-display);font-size:20px;line-height:1.1;margin-bottom:4px}.db-status-sub{font-size:11px;color:var(--text3)}.db-metric{padding-right:18px;border-right:1px solid var(--border)}.db-metric:last-child{border-right:none}.db-metric-label{font-size:10px;letter-spacing:.06em;text-transform:uppercase;color:var(--text3);font-weight:600;margin-bottom:6px}.db-metric-val{font-family:var(--font-display);font-size:28px;letter-spacing:-0.01em}.db-metric-delta{font-size:11px;margin-top:5px;font-weight:500}.db-metric-delta.up{color:var(--green)}.db-metric-delta.down{color:var(--red)}
/* Gantt */
.gantt{border:1px solid var(--border);border-radius:var(--r2);overflow:hidden;box-shadow:var(--sh-sm)}.gantt-header{position:relative;height:36px;border-bottom:1px solid var(--border);background:var(--bg2);font-size:10px;color:var(--text3);font-weight:500}.gantt-group{padding:10px 16px;font-size:11px;font-weight:600;color:var(--text3);background:var(--bg2);border-bottom:1px solid var(--border);letter-spacing:.04em;text-transform:uppercase;display:flex;align-items:center;justify-content:space-between}.gantt-group-meta{font-weight:400;text-transform:none;letter-spacing:0}.gantt-row{position:relative;height:44px;border-bottom:1px solid var(--border);cursor:pointer;transition:background .1s}.gantt-row:hover{background:var(--bg2)}.gantt-row:last-child{border-bottom:none}.gantt-bar{position:absolute;top:8px;height:28px;border-radius:6px;display:flex;align-items:center;padding-left:8px;gap:5px;font-size:10px;font-weight:600;overflow:hidden;white-space:nowrap}.gantt-bar-dot{width:6px;height:6px;border-radius:50%;flex-shrink:0}.gantt-today{position:absolute;top:0;bottom:0;width:2px;background:var(--accent);z-index:2}.gantt-today-label{position:absolute;top:2px;left:-12px;font-size:9px;color:var(--accent);font-weight:600;background:var(--bg2);padding:0 3px}
.sched-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:18px}.sched-stat{background:var(--bg);border:1px solid var(--border);border-radius:var(--r3);padding:16px 18px;box-shadow:var(--sh-sm)}.sched-stat-label{font-size:10px;font-weight:600;color:var(--text3);text-transform:uppercase;letter-spacing:.04em;margin-bottom:6px}.sched-stat-val{font-family:var(--font-display);font-size:28px;letter-spacing:-0.02em}.sched-stat-sub{font-size:11px;color:var(--text3);margin-top:3px}
/* Empty workspace */
.empty-workspace{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:50vh;text-align:center;padding:40px 20px}.empty-icon{width:72px;height:72px;border-radius:20px;background:var(--accent-bg);display:grid;place-items:center;font-size:32px;margin-bottom:20px;box-shadow:0 4px 16px rgba(235,33,46,.1)}.empty-title{font-family:var(--font-display);font-size:32px;font-weight:400;margin-bottom:8px;letter-spacing:-0.01em}.empty-desc{font-size:14px;color:var(--text3);max-width:420px;line-height:1.6;margin-bottom:24px}.empty-actions{display:flex;gap:10px;margin-bottom:32px}
.quickstart{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;max-width:680px;width:100%}.quickstart-card{background:var(--bg);border:1px solid var(--border);border-radius:var(--r3);padding:20px;text-align:left;cursor:pointer;transition:all .12s}.quickstart-card:hover{box-shadow:var(--sh);border-color:var(--border2)}.quickstart-icon{font-size:20px;margin-bottom:10px}.quickstart-title{font-size:14px;font-weight:600;margin-bottom:4px}.quickstart-desc{font-size:12px;color:var(--text3);line-height:1.5}
/* Ship */
.ship-card{background:linear-gradient(180deg,var(--bg2),var(--bg));border:1px solid var(--border);border-radius:var(--r3);padding:28px;margin-top:20px;box-shadow:var(--sh)}.ship-title{font-family:var(--font-display);font-size:24px;margin-bottom:8px;font-weight:400}.ship-desc{font-size:13px;color:var(--text3);margin-bottom:20px;line-height:1.6}.ship-options{display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px}.ship-opt{border:1px solid var(--border);border-radius:var(--r2);padding:18px;cursor:pointer;transition:all .12s;text-align:center;background:var(--bg)}.ship-opt:hover{border-color:var(--accent);box-shadow:var(--sh-sm)}.ship-opt-icon{font-size:24px;margin-bottom:8px}.ship-opt-title{font-size:13px;font-weight:600;margin-bottom:3px}.ship-opt-desc{font-size:11px;color:var(--text3)}
...
function LoginPage({ onLogin }) {
  ...
  return <div className="login-page">
    <div className="login-hero"><div className="login-hero-mark">OS</div><h2>Campaign intelligence for <em style={{fontStyle:"italic"}}>EV charging</em></h2><p>Build, simulate, and ship offer campaigns that drive growth — powered by data, not guesswork.</p></div>
