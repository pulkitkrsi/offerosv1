...
:root,.light{--bg:#f7faf7;--bg2:#ffffff;--bg3:#eef4ef;--bg4:#dde8de;--border:#e4ede8;--border2:#cfdcd5;--text:#0f1f1a;--text2:#4a5f57;--text3:#8a9c93;--mint:#00d68f;--mint2:#00b377;--mint-soft:#dff8ee;--mint-deep:#005a3c;--accent:#00d68f;--accent2:#00b377;--accent-bg:#dff8ee;--accent-soft:rgba(0,214,143,.12);--sky:#5fa8ff;--sky-soft:#e2efff;--peach:#ffb084;--peach-soft:#ffeadd;--green:#00b377;--green-bg:#dff8ee;--red:#e04848;--red-bg:#fdeaea;--amber:#d4930d;--amber-bg:#fef6e0;--blue:#5fa8ff;--blue-bg:#e2efff;--purple:#9b6dd7;--purple-bg:#f0e8ff;--teal:#00b377;--teal-bg:#dff8ee;--sage:#00b377;--sage-bg:#dff8ee;--r:10px;--r2:16px;--r3:24px;--r4:32px;--sh-sm:0 1px 2px rgba(15,30,25,.04);--sh:0 1px 2px rgba(15,30,25,.04),0 14px 32px -14px rgba(15,30,25,.10);--sh-lg:0 32px 60px -28px rgba(15,30,25,.20);--font-ui:'Inter',-apple-system,sans-serif;--font-mono:'JetBrains Mono',monospace;--font-display:'Inter',-apple-system,sans-serif}
.dark{--bg:#0a1410;--bg2:#10201a;--bg3:#1a2a23;--bg4:#26382f;--border:#1a2a23;--border2:#26382f;--text:#eef7f3;--text2:#a9bfb6;--text3:#6e827a;--mint-soft:rgba(0,214,143,.12);--sky-soft:rgba(95,168,255,.12);--peach-soft:rgba(255,176,132,.12);--accent-bg:rgba(0,214,143,.12);--accent-soft:rgba(0,214,143,.15);--green-bg:rgba(0,179,119,.1);--red-bg:rgba(224,72,72,.1);--amber-bg:rgba(212,147,13,.1);--blue-bg:rgba(95,168,255,.1);--purple-bg:rgba(155,109,215,.1);--sh-sm:0 1px 2px rgba(0,0,0,.3);--sh:0 2px 8px rgba(0,0,0,.35);--sh-lg:0 12px 30px rgba(0,0,0,.5)}
...
/* Sidebar */
.sidebar{background:var(--bg2);border-right:1px solid var(--border);padding:18px 14px;display:flex;flex-direction:column;gap:2px;position:sticky;top:0;height:100vh;overflow-y:auto}
.sb-brand{display:flex;align-items:center;gap:10px;padding:6px 8px 20px;font-size:15px;font-weight:600;letter-spacing:-0.01em;cursor:pointer}.sb-brand-mark{width:30px;height:30px;border-radius:10px;background:var(--mint);color:#06231a;display:grid;place-items:center;font-weight:700;font-size:11px;flex-shrink:0}
.sb-org{display:flex;align-items:center;gap:8px;padding:9px 10px;border:1px solid var(--border);border-radius:var(--r);margin-bottom:14px;cursor:pointer;transition:all .12s}.sb-org:hover{background:var(--bg3)}.sb-org-avatar{width:26px;height:26px;border-radius:8px;background:linear-gradient(135deg,var(--mint),var(--sky));color:#fff;display:grid;place-items:center;font-size:10px;font-weight:700;flex-shrink:0}.sb-org .name{flex:1;font-size:13px;font-weight:500}.sb-org .caret{color:var(--text3);font-size:12px}
.sb-section{padding:16px 10px 6px;font-size:10px;letter-spacing:.08em;text-transform:uppercase;color:var(--text3);font-weight:600}
.sb-item{display:flex;align-items:center;gap:10px;padding:10px 11px;border-radius:14px;color:var(--text3);font-size:13.5px;cursor:pointer;width:100%;text-align:left;transition:all .12s;font-weight:500;border:1px solid transparent}.sb-item:hover{background:var(--bg3);color:var(--text)}.sb-item.active{background:var(--bg2);color:var(--text);border-color:var(--border);box-shadow:var(--sh-sm)}.sb-item .icon{width:16px;height:16px;display:flex;align-items:center;flex-shrink:0}.sb-item .badge{margin-left:auto;font-size:10px;background:var(--mint-soft);color:var(--mint-deep);padding:2px 8px;border-radius:10px;font-weight:600}
.sb-foot{margin-top:auto;padding:14px 8px;border-top:1px solid var(--border);display:flex;align-items:center;gap:10px}.sb-foot-avatar{width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,var(--mint),var(--sky));color:#fff;display:grid;place-items:center;font-size:12px;font-weight:600;flex-shrink:0}.sb-foot .who{font-size:13px;font-weight:500}.sb-foot .role{font-size:11px;color:var(--text3)}
/* Topbar */
.topbar{display:flex;align-items:center;gap:14px;padding:14px 28px;border-bottom:1px solid var(--border);background:rgba(247,250,247,.85);backdrop-filter:blur(8px);position:sticky;top:0;z-index:10}
...
.content{padding:0 28px 60px;max-width:1200px;width:100%}
.page-hdr{padding:28px 0 22px}.page-hdr h1{font-size:32px;font-weight:600;letter-spacing:-0.025em;line-height:1.1}.page-hdr-sub{font-size:13px;color:var(--text3);cursor:pointer;display:flex;align-items:center;gap:4px;margin-bottom:6px}.page-hdr-sub:hover{color:var(--text)}
/* Cards — pillowy */
.card{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:22px;margin-bottom:16px;box-shadow:var(--sh-sm)}.card-title{font-size:20px;font-weight:600;margin-bottom:16px;letter-spacing:-0.015em}
/* Segments */
.seg-cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:10px;margin-bottom:14px}.seg-card{border:1px solid var(--border);border-radius:var(--r2);padding:16px;cursor:pointer;transition:all .15s;background:var(--bg2)}.seg-card:hover{border-color:var(--border2);box-shadow:var(--sh-sm);transform:translateY(-1px)}.seg-card.selected{border-color:var(--mint);background:var(--mint-soft);box-shadow:0 0 0 3px var(--accent-soft)}.seg-card-icon{font-size:22px;margin-bottom:8px}.seg-card-name{font-weight:600;font-size:14px;margin-bottom:3px}.seg-card-desc{font-size:12px;color:var(--text3);margin-bottom:8px}.seg-card-insight{font-size:11px;color:var(--text2);line-height:1.5;padding-top:8px;border-top:1px solid var(--border);font-style:italic}
.csv-zone{margin-top:14px;padding:18px;border:1px dashed var(--border2);border-radius:var(--r2);background:var(--bg3);transition:all .12s;cursor:pointer;text-align:center}.csv-zone:hover{border-color:var(--mint);background:var(--mint-soft)}.csv-zone.has{border-color:var(--mint);border-style:solid;background:var(--mint-soft)}.csv-logic{margin-top:10px;display:flex;gap:8px;align-items:center;font-size:12px;color:var(--text3)}
.field{display:flex;flex-direction:column;gap:5px}.field-label{font-size:12px;color:var(--text2);font-weight:500}.grid2{display:grid;grid-template-columns:1fr 1fr;gap:14px}
input[type=text],input[type=number],input[type=date],input[type=password],select,textarea{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r);padding:11px 14px;color:var(--text);font-size:14px;width:100%;transition:border-color .12s}input:focus,select:focus,textarea:focus{outline:none;border-color:var(--mint);box-shadow:0 0 0 3px var(--mint-soft)}input::placeholder{color:var(--text3)}select{cursor:pointer}
.preload-box{margin-top:16px;padding:18px;background:var(--bg3);border:1px solid var(--border);border-radius:var(--r2)}.toggle-row{display:flex;align-items:center;justify-content:space-between}.toggle-label{font-size:13px;font-weight:600}.toggle-sub{font-size:11px;color:var(--text3)}.toggle-track{width:44px;height:24px;border-radius:12px;background:var(--bg4);cursor:pointer;position:relative;transition:.2s;flex-shrink:0}.toggle-track.on{background:var(--mint)}.toggle-thumb{position:absolute;width:18px;height:18px;border-radius:50%;top:3px;left:3px;background:#fff;transition:.2s;box-shadow:0 1px 3px rgba(0,0,0,.12)}.toggle-track.on .toggle-thumb{transform:translateX(20px)}
.dist-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:14px 0}.dist-item{border:1px solid var(--border);border-radius:var(--r2);padding:14px;cursor:pointer;transition:all .12s;background:var(--bg2)}.dist-item:hover{border-color:var(--border2);transform:translateY(-1px)}.dist-item.selected{border-color:var(--mint);background:var(--mint-soft)}.dist-item-title{font-size:12px;font-weight:600;margin-bottom:3px}.dist-item-desc{font-size:11px;color:var(--text3)}
.act-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px}.act-item{border:1px solid var(--border);border-radius:var(--r3);padding:20px;cursor:pointer;transition:all .15s;background:var(--bg2)}.act-item:hover{box-shadow:var(--sh);transform:translateY(-1px)}.act-item.selected{border-color:var(--mint);background:var(--mint-soft);box-shadow:0 0 0 3px var(--accent-soft)}.act-item-icon{font-size:24px;margin-bottom:8px}.act-item-title{font-size:14px;font-weight:600;margin-bottom:3px}.act-item-vars{font-size:12px;color:var(--text3)}
.rwd-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:18px}.rwd-item{border:1px solid var(--border);border-radius:var(--r2);padding:16px;cursor:pointer;transition:all .15s;background:var(--bg2)}.rwd-item:hover{box-shadow:var(--sh-sm);transform:translateY(-1px)}.rwd-item.selected{border-color:var(--mint);background:var(--mint-soft)}.rwd-item.disabled{opacity:.25;pointer-events:none}.rwd-item-name{font-size:14px;font-weight:600;margin-bottom:3px}.rwd-item-formula{font-size:12px;color:var(--text3)}
.rwd-disabled{padding:14px 16px;background:var(--mint-soft);border:1px solid rgba(0,179,119,.15);border-radius:var(--r);font-size:13px;color:var(--mint-deep);margin-bottom:18px;line-height:1.6}
.rwd-config{background:var(--bg3);border:1px solid var(--border);border-radius:var(--r2);padding:18px 22px;margin-top:8px}.rwd-config-title{font-size:10px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:var(--text3);margin-bottom:16px}
.tier-hdr,.tier-row{display:grid;grid-template-columns:80px 1fr 28px;gap:10px;margin-bottom:8px;align-items:center}.tier-hdr span{font-size:10px;color:var(--text3);font-weight:600;text-transform:uppercase;letter-spacing:.04em}
.wt-box{margin-top:18px;padding:18px 20px;border:1px solid rgba(0,214,143,.2);border-radius:var(--r2);background:var(--mint-soft)}.wt-title{font-size:10px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:var(--mint-deep);margin-bottom:14px}
.wt-modes{display:flex;gap:8px;margin-bottom:14px}.wt-mode{padding:8px 18px;border-radius:14px;border:1px solid var(--border);background:var(--bg2);color:var(--text3);font-size:12px;cursor:pointer;font-weight:500;transition:all .15s}.wt-mode:hover{border-color:var(--text3);transform:translateY(-1px)}.wt-mode.active{border-color:var(--mint);color:var(--mint-deep);background:var(--mint-soft)}
.slab-hdr,.slab-row{display:grid;grid-template-columns:80px 80px 70px 28px;gap:8px;margin-bottom:6px;align-items:center}.slab-hdr span{font-size:10px;color:var(--text3);font-weight:600;text-transform:uppercase;letter-spacing:.04em}
.bc-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.bc-note{font-size:12px;color:var(--text2);margin-top:14px;padding:12px 16px;background:var(--bg3);border-left:3px solid var(--mint);border-radius:0 var(--r) var(--r) 0;line-height:1.6}
.sum-card{border:1px solid var(--border);border-radius:var(--r3);overflow:hidden;margin-bottom:18px;box-shadow:var(--sh-sm)}.sum-hdr{padding:18px 24px;background:var(--bg3);border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center}.sum-name{font-size:20px;font-weight:600;letter-spacing:-0.015em}
.badge{font-size:10px;padding:4px 12px;border-radius:999px;font-weight:600}.bg-cashback{background:var(--mint-soft);color:var(--mint-deep)}.bg-discount{background:var(--amber-bg);color:var(--amber)}.bg-xp{background:var(--purple-bg);color:var(--purple)}.bg-coupon{background:var(--sky-soft);color:var(--sky)}.bg-preload{background:var(--mint-soft);color:var(--mint-deep)}
.sum-body{padding:24px}.sum-plain{font-size:14px;line-height:1.9;color:var(--text2);margin-bottom:24px;padding:18px 20px;background:var(--bg3);border-radius:var(--r2);border-left:3px solid var(--mint)}.sum-plain strong{color:var(--mint-deep);font-weight:600}
.vtable{width:100%;border-collapse:collapse}.vtable th{font-size:10px;font-weight:600;letter-spacing:.04em;text-transform:uppercase;color:var(--text3);text-align:left;padding:8px 12px;border-bottom:1px solid var(--border)}.vtable td{padding:8px 12px;border-bottom:1px solid var(--border);font-size:13px}.vtable tr:last-child td{border-bottom:none}.vtable tr:hover td{background:var(--bg3)}
.txn-hdr,.txn-row{display:grid;grid-template-columns:130px 90px 80px 28px;gap:10px;margin-bottom:8px;align-items:center}.txn-hdr span{font-size:10px;color:var(--text3);font-weight:600;text-transform:uppercase;letter-spacing:.04em}
.sample-btn{width:100%;padding:12px;margin-bottom:16px;border:1px dashed var(--mint);border-radius:14px;background:var(--mint-soft);color:var(--mint-deep);font-size:13px;font-weight:500;cursor:pointer;transition:all .15s}.sample-btn:hover{transform:translateY(-1px);box-shadow:var(--sh)}
.dash-section{margin-bottom:28px}.dash-title{font-size:20px;font-weight:600;margin-bottom:16px;display:flex;align-items:center;gap:12px;letter-spacing:-0.015em}.dash-icon{width:32px;height:32px;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0}.di-g{background:var(--mint-soft);color:var(--mint-deep)}.di-a{background:var(--amber-bg);color:var(--amber)}.di-r{background:var(--peach-soft);color:var(--peach)}
.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:12px}.mc{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:18px;box-shadow:var(--sh-sm)}.mc-label{font-size:10px;font-weight:600;color:var(--text3);letter-spacing:.04em;text-transform:uppercase;margin-bottom:8px}.mc-val{font-size:28px;font-weight:600;letter-spacing:-0.02em;font-variant-numeric:tabular-nums}.mc-sub{font-size:11px;color:var(--text3);margin-top:5px}
.result-tbl{width:100%;border-collapse:collapse;font-size:12px}.result-tbl th{font-size:10px;font-weight:600;letter-spacing:.04em;text-transform:uppercase;color:var(--text3);text-align:left;padding:10px;border-bottom:1px solid var(--border)}.result-tbl td{padding:10px;border-bottom:1px solid var(--border);color:var(--text2)}.result-tbl tr:last-child td{border-bottom:none}.result-tbl tr:hover td{background:var(--bg3)}.result-tbl td.rval{color:var(--mint-deep);font-family:var(--font-mono);font-weight:600}
.sbadge{font-size:10px;padding:3px 10px;border-radius:999px;font-weight:500;display:inline-block}.bg-green{background:var(--mint-soft);color:var(--mint-deep)}.bg-amber{background:var(--amber-bg);color:var(--amber)}.bg-red{background:var(--red-bg);color:var(--red)}.bg-blue{background:var(--sky-soft);color:var(--sky)}.bg-muted{background:var(--bg3);color:var(--text3)}
.risk-item{display:flex;align-items:flex-start;gap:10px;padding:14px 16px;border-radius:14px;margin-bottom:8px;font-size:13px;line-height:1.6}.risk-item.risk{background:var(--red-bg);color:var(--red)}.risk-item.warn{background:var(--amber-bg);color:var(--amber)}.risk-item.ok{background:var(--mint-soft);color:var(--mint-deep)}
.btn-row{display:flex;gap:10px;margin-top:22px}.btn{display:inline-flex;align-items:center;gap:8px;padding:11px 20px;border-radius:14px;font-size:14px;font-weight:500;transition:transform .15s,box-shadow .2s;border:1px solid var(--border);background:var(--bg2);color:var(--text)}.btn:hover{transform:translateY(-1px);box-shadow:var(--sh)}.btn-primary{background:var(--mint);color:#06231a;border-color:var(--mint);font-weight:600}.btn-primary:hover{background:var(--mint2)}.btn-dashed{width:100%;padding:10px;border:1px dashed var(--border2);border-radius:14px;background:none;font-size:12px;color:var(--text3);cursor:pointer;font-weight:500;margin-top:8px;transition:all .15s}.btn-dashed:hover{border-color:var(--mint);color:var(--mint-deep)}.del-btn{background:none;border:none;color:var(--text3);cursor:pointer;font-size:15px;transition:color .12s}.del-btn:hover{color:var(--red)}.scroll-x{overflow-x:auto}
.steps{display:flex;gap:0;margin-bottom:20px;background:var(--bg2);border:1px solid var(--border);border-radius:var(--r2);padding:4px;overflow-x:auto}.step{flex:1;padding:10px 8px;font-size:12px;cursor:pointer;color:var(--text3);text-align:center;border-radius:14px;transition:all .12s;white-space:nowrap;font-weight:500}.step:hover{color:var(--text2)}.step.active{background:var(--bg2);color:var(--text);box-shadow:var(--sh-sm)}.step.done{color:var(--mint-deep)}.step.incomplete{color:var(--red)}
.offers-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:14px}.offer-card{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:18px;cursor:pointer;transition:all .15s;position:relative}.offer-card:hover{box-shadow:var(--sh);transform:translateY(-2px)}.offer-card.active{border-color:var(--mint)}.offer-card-actions{position:absolute;top:12px;right:12px;display:flex;gap:4px;opacity:0;transition:opacity .12s}.offer-card:hover .offer-card-actions{opacity:1}.offer-card-actions button{width:28px;height:28px;border-radius:10px;border:1px solid var(--border);background:var(--bg2);font-size:14px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:var(--text3)}.offer-card-actions button:hover{background:var(--bg3);color:var(--text)}.offer-card-actions button.del:hover{color:var(--red)}
.offer-card-type{display:flex;align-items:center;gap:8px;margin-bottom:10px}.offer-card-dot{width:8px;height:8px;border-radius:50%}.offer-card-label{font-size:10px;color:var(--text3);font-weight:600;text-transform:uppercase;letter-spacing:.04em}.offer-card-name{font-size:18px;font-weight:600;margin-bottom:4px;letter-spacing:-0.01em}.offer-card-segs{font-size:12px;color:var(--text3)}
.add-card{border:1px dashed var(--border2);border-radius:var(--r3);padding:18px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:var(--text3);font-size:14px;font-weight:500;min-height:120px;transition:all .15s}.add-card:hover{border-color:var(--mint);color:var(--mint-deep);background:var(--mint-soft);transform:translateY(-2px)}
.campaign-list{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:14px;margin-bottom:22px}.campaign-card{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:22px;cursor:pointer;transition:all .15s}.campaign-card:hover{box-shadow:var(--sh);transform:translateY(-2px)}.campaign-card-name{font-size:20px;font-weight:600;margin-bottom:8px;letter-spacing:-0.01em}.campaign-card-meta{font-size:12px;color:var(--text3);display:flex;gap:14px}
.save-indicator{font-size:11px;color:var(--text3);display:flex;align-items:center;gap:4px}.save-indicator.saving{color:var(--mint)}.save-indicator.saved{color:var(--mint-deep)}
.theme-toggle{width:34px;height:20px;border-radius:10px;background:var(--bg4);cursor:pointer;position:relative;transition:.2s;border:1px solid var(--border);flex-shrink:0}.theme-toggle .thumb{position:absolute;width:14px;height:14px;border-radius:50%;top:2px;left:2px;background:var(--text3);transition:.2s}.dark .theme-toggle .thumb{transform:translateX(14px);background:var(--mint)}
.user-badge{display:flex;align-items:center;gap:6px;padding:4px;cursor:pointer;border-radius:var(--r);transition:background .12s}.user-badge:hover{background:var(--bg3)}.user-badge-avatar{width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,var(--mint),var(--sky));color:#fff;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:600}
.modal-overlay{position:fixed;inset:0;background:rgba(15,31,26,.35);display:flex;align-items:center;justify-content:center;z-index:200;backdrop-filter:blur(6px)}.modal{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:30px;max-width:460px;width:92%;box-shadow:var(--sh-lg)}.modal-title{font-size:22px;font-weight:600;margin-bottom:8px;letter-spacing:-0.015em}.modal-msg{font-size:13px;color:var(--text2);margin-bottom:22px;line-height:1.6}.modal-actions{display:flex;gap:10px;justify-content:flex-end}
/* Login — minimal Pulse */
.login-page{min-height:100vh;display:grid;grid-template-columns:1fr 1fr;background:var(--bg)}.login-hero{background:linear-gradient(135deg,var(--mint-soft),var(--sky-soft));display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 40px;position:relative;overflow:hidden}.login-hero::before{content:'';position:absolute;width:300px;height:300px;border-radius:50%;background:radial-gradient(circle,var(--mint-soft) 30%,transparent 70%);top:10%;right:-50px;animation:pulse-blob 6s ease-in-out infinite}@keyframes pulse-blob{0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(8px,-8px) scale(1.04)}}.login-hero-mark{width:60px;height:60px;border-radius:16px;background:var(--mint);color:#06231a;display:grid;place-items:center;font-weight:700;font-size:22px;margin-bottom:24px}.login-hero h2{font-size:40px;font-weight:600;text-align:center;line-height:1.1;margin-bottom:12px;letter-spacing:-0.03em}.login-hero p{font-size:15px;color:var(--text2);text-align:center;max-width:360px;line-height:1.6}
.login-form{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 40px}.login-card{max-width:380px;width:100%}.login-title{font-size:24px;font-weight:600;text-align:center;margin-bottom:4px;letter-spacing:-0.02em}.login-sub{font-size:13px;color:var(--text3);text-align:center;margin-bottom:30px}
.login-field{margin-bottom:18px}.login-field label{display:block;font-size:11px;font-weight:600;color:var(--text2);margin-bottom:6px;text-transform:uppercase;letter-spacing:.06em}
.login-err{padding:12px 16px;background:var(--red-bg);border-radius:14px;font-size:13px;color:var(--red);margin-bottom:18px;text-align:center}
.login-btn{width:100%;padding:14px;background:var(--mint);border:none;border-radius:14px;color:#06231a;font-size:14px;font-weight:600;cursor:pointer;transition:all .15s;margin-top:8px}.login-btn:hover{background:var(--mint2);transform:translateY(-1px);box-shadow:var(--sh)}.login-btn:disabled{opacity:.5;cursor:not-allowed}
/* AI drawer */
...
.ai-drawer{position:fixed;top:0;right:-360px;width:360px;height:100vh;background:var(--bg2);border-left:1px solid var(--border);z-index:31;display:flex;flex-direction:column;transition:right .25s ease;box-shadow:var(--sh-lg)}.ai-drawer.open{right:0}
.ai-hdr{padding:18px 20px;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between}.ai-hdr-t{font-size:16px;font-weight:600;display:flex;align-items:center;gap:10px;color:var(--mint-deep)}
.pulse{width:8px;height:8px;border-radius:50%;background:var(--mint);box-shadow:0 0 8px rgba(0,214,143,.4);animation:pulse-glow 2s infinite}@keyframes pulse-glow{0%,100%{opacity:1}50%{opacity:.4}}
.ai-x{background:none;border:none;color:var(--text3);cursor:pointer;font-size:18px;padding:4px 8px;border-radius:10px;transition:all .1s}.ai-x:hover{background:var(--bg3);color:var(--text)}
.ai-body{flex:1;overflow-y:auto;padding:18px}.ai-msg{margin-bottom:14px;padding:14px 16px;border-radius:var(--r2);font-size:13px;line-height:1.7;color:var(--text2)}.ai-msg.bot{background:var(--bg3);border:1px solid var(--border)}.ai-msg.user{background:var(--text);color:var(--bg);border-radius:var(--r2) var(--r2) 4px var(--r2)}.ai-msg strong{color:var(--mint-deep);font-weight:600}.ai-msg code{font-family:var(--font-mono);font-size:11px;background:var(--bg4);padding:2px 5px;border-radius:6px}
.ai-dots{display:flex;align-items:center;gap:8px;padding:14px;color:var(--mint);font-size:12px}.ai-dots i{width:6px;height:6px;border-radius:50%;background:var(--mint);display:inline-block;animation:blink 1.2s infinite;opacity:.3}.ai-dots i:nth-child(2){animation-delay:.2s}.ai-dots i:nth-child(3){animation-delay:.4s}@keyframes blink{0%,100%{opacity:.3}50%{opacity:1}}
.ai-ftr{padding:16px;border-top:1px solid var(--border)}.ai-ftr-row{display:flex;gap:8px}.ai-inp{flex:1;background:var(--bg3);border:1px solid var(--border);border-radius:14px;padding:11px 14px;color:var(--text);font-size:12px}.ai-inp:focus{outline:none;border-color:var(--mint)}.ai-go{background:var(--mint);border:none;border-radius:14px;color:#06231a;font-size:12px;padding:9px 18px;cursor:pointer;font-weight:600}.ai-go:hover{background:var(--mint2)}
.ai-qa{display:flex;gap:6px;margin-top:10px;flex-wrap:wrap}.ai-qa button{padding:5px 12px;font-size:11px;border:1px solid var(--border);border-radius:999px;background:var(--bg2);color:var(--text3);cursor:pointer;font-weight:500;transition:all .12s}.ai-qa button:hover{border-color:var(--mint);color:var(--mint-deep)}
/* What-If */
.wif-grid{display:grid;grid-template-columns:320px 1fr;gap:22px}.wif-knobs{display:flex;flex-direction:column;gap:14px}.wif-knob{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r2);padding:16px 18px}.wif-knob-head{display:flex;align-items:baseline;justify-content:space-between;margin-bottom:10px}.wif-knob-label{font-size:10px;letter-spacing:.04em;text-transform:uppercase;color:var(--text3);font-weight:600}.wif-knob-val{font-size:24px;font-weight:600;letter-spacing:-0.02em;font-variant-numeric:tabular-nums}.wif-knob-val .unit{font-size:13px;color:var(--text3);margin-left:2px}.wif-track{height:6px;background:var(--bg4);border-radius:3px;position:relative;cursor:pointer;margin:10px 0}.wif-track-fill{position:absolute;top:0;left:0;bottom:0;background:var(--mint);border-radius:3px}.wif-track-thumb{position:absolute;top:50%;width:18px;height:18px;border-radius:50%;background:#fff;border:2px solid var(--mint);transform:translate(-50%,-50%);box-shadow:0 2px 6px rgba(0,0,0,.18)}.wif-knob-meta{display:flex;justify-content:space-between;font-size:10px;color:var(--text3)}.wif-result{display:flex;flex-direction:column;gap:14px}.wif-headline{background:linear-gradient(135deg,var(--mint-soft),var(--sky-soft));border:1px solid var(--border);border-radius:var(--r3);padding:24px;display:grid;grid-template-columns:1fr 1fr 1fr;gap:22px}.wif-headline-block{padding-right:20px;border-right:1px solid var(--border)}.wif-headline-block:last-child{border-right:none;padding-right:0}.wif-headline-label{font-size:10px;letter-spacing:.06em;text-transform:uppercase;color:var(--mint-deep);font-weight:600;margin-bottom:8px}.wif-headline-val{font-size:32px;font-weight:600;letter-spacing:-0.02em;line-height:1;font-variant-numeric:tabular-nums}.wif-headline-delta{display:flex;align-items:center;gap:6px;margin-top:8px;font-size:11px;color:var(--text3)}.wif-chip{font-family:var(--font-mono);font-size:10px;padding:2px 8px;border-radius:999px;font-weight:600}.wif-chip.up{background:var(--mint-soft);color:var(--mint-deep)}.wif-chip.down{background:var(--red-bg);color:var(--red)}.wif-narrative{background:var(--mint-soft);border:1px solid rgba(0,214,143,.2);border-radius:var(--r2);padding:16px 18px;font-size:13px;color:var(--text2);line-height:1.7}.wif-narrative b{font-weight:600;color:var(--mint-deep)}
/* Decision Board */
.db-summary{background:linear-gradient(135deg,var(--mint-soft),var(--sky-soft));border:1px solid var(--border);border-radius:var(--r3);padding:22px 24px;margin-bottom:20px;display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:22px;align-items:center}.db-status{border-right:1px solid var(--border);padding-right:22px}.db-status-orb{width:40px;height:40px;border-radius:12px;display:grid;place-items:center;font-size:20px;margin-bottom:8px}.db-status-orb.healthy{background:var(--mint-soft);color:var(--mint-deep)}.db-status-orb.caution{background:var(--amber-bg);color:var(--amber)}.db-status-orb.risk{background:var(--red-bg);color:var(--red)}.db-status-text{font-size:18px;font-weight:600;letter-spacing:-0.01em;margin-bottom:4px}.db-status-sub{font-size:11px;color:var(--text3)}.db-metric{padding-right:18px;border-right:1px solid var(--border)}.db-metric:last-child{border-right:none}.db-metric-label{font-size:10px;letter-spacing:.06em;text-transform:uppercase;color:var(--text3);font-weight:600;margin-bottom:6px}.db-metric-val{font-size:26px;font-weight:600;letter-spacing:-0.01em;font-variant-numeric:tabular-nums}.db-metric-delta{font-size:11px;margin-top:5px;font-weight:500}.db-metric-delta.up{color:var(--mint-deep)}.db-metric-delta.down{color:var(--red)}
/* Gantt */
.gantt{border:1px solid var(--border);border-radius:var(--r3);overflow:hidden;box-shadow:var(--sh-sm)}.gantt-header{position:relative;height:36px;border-bottom:1px solid var(--border);background:var(--bg3);font-size:10px;color:var(--text3);font-weight:500}.gantt-group{padding:10px 16px;font-size:11px;font-weight:600;color:var(--text3);background:var(--bg3);border-bottom:1px solid var(--border);letter-spacing:.04em;text-transform:uppercase;display:flex;align-items:center;justify-content:space-between}.gantt-group-meta{font-weight:400;text-transform:none;letter-spacing:0}.gantt-row{position:relative;height:44px;border-bottom:1px solid var(--border);cursor:pointer;transition:background .1s}.gantt-row:hover{background:var(--bg3)}.gantt-bar{position:absolute;top:8px;height:28px;border-radius:10px;display:flex;align-items:center;padding-left:8px;gap:5px;font-size:10px;font-weight:600;overflow:hidden;white-space:nowrap}.gantt-bar-dot{width:6px;height:6px;border-radius:50%;flex-shrink:0}.gantt-today{position:absolute;top:0;bottom:0;width:2px;background:var(--mint);z-index:2}.gantt-today-label{position:absolute;top:2px;left:-12px;font-size:9px;color:var(--mint-deep);font-weight:600;background:var(--bg3);padding:0 3px}
.sched-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:18px}.sched-stat{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:16px 18px;box-shadow:var(--sh-sm)}.sched-stat-label{font-size:10px;font-weight:600;color:var(--text3);text-transform:uppercase;letter-spacing:.04em;margin-bottom:6px}.sched-stat-val{font-size:26px;font-weight:600;letter-spacing:-0.02em;font-variant-numeric:tabular-nums}.sched-stat-sub{font-size:11px;color:var(--text3);margin-top:3px}
/* Empty workspace */
.empty-workspace{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:50vh;text-align:center;padding:40px 20px}.empty-icon{width:72px;height:72px;border-radius:20px;background:var(--mint-soft);display:grid;place-items:center;font-size:32px;margin-bottom:20px}.empty-title{font-size:28px;font-weight:600;margin-bottom:8px;letter-spacing:-0.02em}.empty-desc{font-size:14px;color:var(--text3);max-width:420px;line-height:1.6;margin-bottom:24px}.empty-actions{display:flex;gap:10px;margin-bottom:32px}
.quickstart{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;max-width:680px;width:100%}.quickstart-card{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r3);padding:20px;text-align:left;cursor:pointer;transition:all .15s}.quickstart-card:hover{box-shadow:var(--sh);transform:translateY(-2px)}.quickstart-icon{font-size:20px;margin-bottom:10px}.quickstart-title{font-size:14px;font-weight:600;margin-bottom:4px}.quickstart-desc{font-size:12px;color:var(--text3);line-height:1.5}
/* Ship */
.ship-card{background:linear-gradient(135deg,var(--mint-soft),var(--sky-soft));border:1px solid var(--border);border-radius:var(--r3);padding:28px;margin-top:20px;box-shadow:var(--sh)}.ship-title{font-size:22px;font-weight:600;margin-bottom:8px;letter-spacing:-0.015em}.ship-desc{font-size:13px;color:var(--text3);margin-bottom:20px;line-height:1.6}.ship-options{display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px}.ship-opt{border:1px solid var(--border);border-radius:var(--r2);padding:18px;cursor:pointer;transition:all .15s;text-align:center;background:var(--bg2)}.ship-opt:hover{border-color:var(--mint);box-shadow:var(--sh-sm);transform:translateY(-1px)}.ship-opt-icon{font-size:24px;margin-bottom:8px}.ship-opt-title{font-size:13px;font-weight:600;margin-bottom:3px}.ship-opt-desc{font-size:11px;color:var(--text3)}
@media(max-width:900px){.app{grid-template-columns:1fr}.sidebar{position:fixed;top:0;left:0;right:0;bottom:auto;height:auto;flex-direction:row;gap:4px;padding:8px 10px;overflow-x:auto;border-right:none;border-bottom:1px solid var(--border);z-index:20}.sb-section,.sb-foot,.sb-org,.sb-brand{display:none}.sb-item{white-space:nowrap;font-size:11px;padding:8px 12px;border-radius:10px}.main-area{padding-top:50px;height:auto}.content{padding:0 16px 60px}.seg-cards,.offers-grid{grid-template-columns:1fr}.grid2,.bc-grid,.act-grid,.rwd-grid,.dist-grid{grid-template-columns:1fr}.metrics,.sched-stats{grid-template-columns:1fr 1fr}.steps{flex-wrap:nowrap}.step{min-width:70px;flex-shrink:0}.ai-drawer{width:100%;right:-100%}.campaign-list{grid-template-columns:1fr}.wif-grid{grid-template-columns:1fr}.wif-headline{grid-template-columns:1fr}.wif-headline-block{border-right:none;border-bottom:1px solid var(--border);padding:0 0 14px}.wif-headline-block:last-child{border-bottom:none}.db-summary{grid-template-columns:1fr}.db-status,.db-metric{border-right:none;border-bottom:1px solid var(--border);padding:0 0 12px}.login-page{grid-template-columns:1fr}.login-hero{display:none}.ship-options{grid-template-columns:1fr}.quickstart{grid-template-columns:1fr}}
...
`;
/* Ship */
.ship-card{background:linear-gradient(135deg,var(--mint-soft),var(--sky-soft));border:1px solid var(--border);border-radius:var(--r3);padding:28px;margin-top:20px}.ship-title{font-size:22px;font-weight:600;margin-bottom:8px;letter-spacing:-0.01em}.ship-desc{font-size:13px;color:var(--text3);margin-bottom:20px;line-height:1.6}.ship-options{display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px}.ship-opt{border:1px solid var(--border);border-radius:var(--r2);padding:18px;cursor:pointer;transition:all .15s;text-align:center;background:var(--bg2)}.ship-opt:hover{transform:translateY(-1px);border-color:var(--mint);box-shadow:var(--sh-sm)}.ship-opt-icon{font-size:24px;margin-bottom:8px}.ship-opt-title{font-size:13px;font-weight:600;margin-bottom:3px}.ship-opt-desc{font-size:11px;color:var(--text3)}
@media(max-width:900px){.app{grid-template-columns:1fr}.sidebar{position:fixed;top:0;left:0;right:0;bottom:auto;height:auto;flex-direction:row;gap:4px;padding:8px 10px;overflow-x:auto;border-right:none;border-bottom:1px solid var(--border);z-index:20}.sb-section,.sb-foot,.sb-org,.sb-brand{display:none}.sb-item{white-space:nowrap;font-size:11px;padding:6px 10px}.main-area{padding-top:50px;height:auto}.content{padding:0 16px 60px}.seg-cards,.offers-grid{grid-template-columns:1fr}.grid2,.bc-grid,.act-grid,.rwd-grid,.dist-grid{grid-template-columns:1fr}.metrics,.sched-stats{grid-template-columns:1fr 1fr}.steps{flex-wrap:nowrap}.step{min-width:70px;flex-shrink:0}.ai-drawer{width:100%;right:-100%}.campaign-list{grid-template-columns:1fr}.wif-grid{grid-template-columns:1fr}.wif-headline,.db-summary{grid-template-columns:1fr}.wif-headline-block,.db-status,.db-metric{border-right:none;border-bottom:1px solid var(--line);padding:0 0 14px}.wif-headline-block:last-child,.db-metric:last-child{border-bottom:none}.login-page{grid-template-columns:1fr}.login-hero{display:none}.ship-options,.quickstart{grid-template-columns:1fr}}
@media(min-width:901px){.mobile-bar{display:none}}
::-webkit-scrollbar{width:10px;height:10px}::-webkit-scrollbar-thumb{background:var(--bg4);border-radius:10px;border:2px solid var(--bg)}::-webkit-scrollbar-thumb:hover{background:var(--text3)}
`;
